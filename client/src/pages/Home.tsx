...
const fadeUp: Variants = { hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0, transition: { duration: 0.5, ease: [0.22, 1, 0.36, 1] } } };
      ...
      <div className="min-h-screen text-white pb-28" style={{ background: "#07100c" }}>
        ...
        <motion.nav
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 18, letterSpacing: "-0.01em" }}>FloraIQ</span>
            <span style={{
        ...
        <div ref={heroRef} style={{ position: "relative", overflow: "hidden", minHeight: 400 }}>
          ...
          <motion.div initial="hidden" animate="show" variants={stagger} style={{ position:"relative", padding:"40px 16px 44px" }}>
            ...
            <h1 style={{
              ...
              fontWeight:600, lineHeight:1.04, marginBottom:12,
              fontSize:"clamp(2.3rem,9.5vw,3.2rem)",
              ...
              <span ref={word3Ref} style={{
                ...
                background:"linear-gradient(135deg,#7fe29d 0%,#55c877 55%,#e9b95c 115%)",
