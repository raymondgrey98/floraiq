...
const TOOLS: Tool[] = [
  ...
  { id:"mushroom",     emoji:"🍄", title:"Mushroom ID",              desc:"Identify fungi — edible vs toxic using AI + MycoPortal",       href:"/mushroom",    category:"Identify",    live:false },
  { id:"pest",         emoji:"🐛", title:"Pest Identifier",          desc:"Photo your pest — AI identifies and suggests treatment",        href:"/pest",        category:"Identify",    live:false },
  ...
  { id:"soil",         emoji:"🪱", title:"Soil pH Guide",            desc:"Match plants to soil pH — test and adjust guide",              href:"/soil",        category:"Care",        live:false },
  { id:"propagation",  emoji:"🌿", title:"Propagation Guide",        desc:"Grow new plants from cuttings, seeds, layering, grafting",    href:"/propagation", category:"Care",        live:false },
  { id:"pruning",      emoji:"✂️", title:"Pruning Guide",            desc:"When and how to prune — by plant type and season",            href:"/pruning",     category:"Care",        live:false },
  ...
  { id:"growthlog",    emoji:"📈", title:"Plant Growth Log",         desc:"Track height, health, photos of your plants over time",       href:"/growth",      category:"Care",        live:false },
  // ── FOOD & FORAGE ──
  ...
  { id:"herb",         emoji:"🌿", title:"Herb & Spice Guide",       desc:"60+ culinary herbs — uses, growing tips, substitutes",        href:"/herbs",       category:"Food",        live:false },
  { id:"edible",       emoji:"🫚", title:"Edible Wild Plants",       desc:"Safe wild plants to eat in Malaysian jungle — ID guide",      href:"/edible",      category:"Food",        live:false },
  { id:"medicinal",    emoji:"💊", title:"Medicinal Plants",         desc:"Traditional Malay & Iban plant medicine database",            href:"/medicinal",   category:"Food",        live:false },
  ...
  { id:"tea",          emoji:"🍵", title:"Wild Tea Plants",          desc:"Plants you can brew into tea — Malaysia jungle guide",        href:"/tea",         category:"Food",        live:false },
  ...
  { id:"irrigation",   emoji:"💦", title:"Irrigation Calculator",    desc:"Water needs per crop type, area, season",                    href:"/irrigation",  category:"Farm",        live:false },
  { id:"rotation",     emoji:"🔄", title:"Crop Rotation Planner",   desc:"Rotate crops to avoid soil depletion and pests",             href:"/rotation",    category:"Farm",        live:false },
  { id:"harvest",      emoji:"🌽", title:"Harvest Predictor",        desc:"Predict harvest date based on planting date and crop type",  href:"/harvest",     category:"Farm",        live:false },
  ...
  { id:"organic",      emoji:"🌱", title:"Organic Pest Control",     desc:"Natural recipes — neem oil, chilli spray, soap spray",       href:"/organic",     category:"Farm",        live:false },
  { id:"compost",      emoji:"♻️", title:"Composting Guide",         desc:"Turn kitchen waste into fertilizer — step by step",          href:"/compost",     category:"Farm",        live:false },
  ...
  { id:"bird",         emoji:"🐦", title:"Bird Guide",               desc:"Malaysian birds — calls, habitat, migration from eBird",    href:"/birds",       category:"Wildlife",    live:false },
  ...
  { id:"butterfly",    emoji:"🦋", title:"Butterfly Garden",         desc:"Attract butterflies — host plants and nectar sources",       href:"/butterfly",   category:"Wildlife",    live:false },
  ...
  { id:"firstaid",     emoji:"🩹", title:"Plant First Aid",          desc:"Jungle plants that treat cuts, stings, bites, fever",       href:"/firstaid",    category:"Survival",    live:false },
