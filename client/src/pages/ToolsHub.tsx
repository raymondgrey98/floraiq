...
const TOOLS: Tool[] = [
  ...
  { id:"honey",        emoji:"🍯", title:"Honey Plants Guide",       desc:"Best plants for bees — attract pollinators to your garden",  href:"/honey",       category:"Food",        live:true  },
  ...
  { id:"fruitguide",   emoji:"🥭", title:"Tropical Fruit Guide",     desc:"40+ Malaysian fruits — season, growing, nutrition",          href:"/fruits",      category:"Food",        live:true  },
  ...
  { id:"market",       emoji:"🏪", title:"Market Price Guide",       desc:"Veg & fruit prices — Sarawak markets in RM",                href:"/market",      category:"Farm",        live:true  },
  ...
  { id:"vertical",     emoji:"🏗️", title:"Vertical Garden Planner",  desc:"Design vertical gardens for small spaces and balconies",     href:"/vertical",    category:"Farm",        live:true  },
  ...
  { id:"reptile",      emoji:"🦎", title:"Reptile Guide",            desc:"Snakes, lizards, frogs of Malaysia — safe vs dangerous",    href:"/reptiles",    category:"Wildlife",    live:true  },
  ...
  { id:"tracks",       emoji:"🐾", title:"Animal Tracks",            desc:"Identify wildlife from footprints and signs",               href:"/tracks",      category:"Wildlife",    live:true  },
  ...
  { id:"shelter",      emoji:"🏕️", title:"Survival Plants Guide",    desc:"Water, food, shelter, fire, rope, medicine from jungle",    href:"/survivalplants",category:"Survival", live:true  },
  { id:"rope",         emoji:"🪢", title:"Cordage Plants",           desc:"Plants you can use as rope, lashing, weaving material",    href:"/survivalplants",category:"Survival", live:true  },
  { id:"fire",         emoji:"🔥", title:"Fire-Starting Plants",     desc:"Tinder, kindling, resin-rich plants for fire making",      href:"/survivalplants",category:"Survival", live:true  },
  { id:"navigate",     emoji:"🧭", title:"Nature Navigation",        desc:"Use sun, stars, moss, and plants for direction finding",   href:"/navigate",    category:"Survival",    live:true  },
  { id:"repellent",    emoji:"🦟", title:"Natural Insect Repellent", desc:"Plants that repel mosquitoes, leeches, and ants",         href:"/repellent",   category:"Survival",    live:true  },
