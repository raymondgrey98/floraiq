...
const FEATURES = [
  ...
  { icon:"🌿", title:"Smart Care", desc:"Every scan returns personalised care — watering schedule, soil type, sunlight needs, fertilizer dose. Tailored to your local climate." },
  ...
  { icon:"🐝", title:"Wildlife Guides", desc:"Wildlife guides covering spiders, reptiles, birds, marine life, nocturnal animals, insects — covering every region on Earth." },
...
const MISSION_PILLARS = [
  ...
  { icon:"💚", title:"Free Forever Core", desc:"The core tools — scan, identify, care guide, maps — remain free. We believe nature identification should be accessible to everyone." },
      ...
      <div className="container py-8 max-w-4xl space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            A nature identification platform that puts a botanist, agronomist, ecologist, and survival expert in your pocket — for free. Built in Kuching, Sarawak. Designed for the world.
          </p>
